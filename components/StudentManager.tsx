    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
           ...
           <p className="text-slate-400">Administra la base de datos de estudiantes por nivel, grado y sección.</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 bg-[#1e293b] p-6 rounded-xl shadow-sm border border-slate-700">
          ...
          {filteredStudents.length === 0 ? (
            <div className="text-center py-12 text-slate-400">
              ...
              <p>No hay estudiantes registrados para este grado y sección.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {filteredStudents.map(student => (
                <div key={student.id} className="bg-[#0f172a] p-4 rounded-xl border border-slate-700 hover:border-blue-500 transition flex items-center justify-between group">
